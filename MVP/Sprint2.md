...
- **Limitações:** Limitação no conhecimento de Power Bi e Google BigQuery para a realização e filtragem dos dados. 
- **Escopo reduzido:** Realização do tratamento de dados e construção so segundo protótipo do dashboard.
...
|--------|----------------------------------------------|----------|
| 02     | Disponibilização da segunda versão do painel | Concluído|
...
* O MVP permite que o usuário faça o filtro por localidade e setores, identificando o alto crescimento porporcional e o reconhecimento de áreas emergentes na economia.

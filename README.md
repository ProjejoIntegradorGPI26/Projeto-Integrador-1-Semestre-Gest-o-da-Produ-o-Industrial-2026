...
| 7 | Baixa | Como tomador de decisões de políticas públicas, quero visualizar textos analíticos gerados automaticamente junto aos dashboards, para facilitar a interpretação dos dados e a comunicação dos resultad | 3 |
